...
\begin{frame}[label={sec:org2fcb5c5}]{Scientific Team}
\begin{itemize}
\item Florent Chatelain, Grenoble INP, GIPSA-lab \includegraphics[width=0.08\linewidth]{pictures/florent.png}
\item Mauro Dalla-Mura, Grenoble INP, GIPSA-lab \includegraphics[width=0.08\linewidth]{pictures/mauro.png}
\item Lucas Drumetz, IMT Atlantique, Lab-STICC \includegraphics[width=0.08\linewidth]{pictures/lucas.png}
\item Ronan Fablet, IMT Atlantique, Lab-STICC \includegraphics[width=0.08\linewidth]{pictures/ronan.jpg}
\item Mathieu Fauvel, INRAe, CESBIO
\item Pierre Tandeo, IMT Atlantique, Lab-STICC \includegraphics[width=0.08\linewidth]{pictures/pierre.png}
\end{itemize}
\end{frame}

\begin{frame}[label={sec:orgf2599a8}]{Local Team}
\begin{itemize}
\item Mathieu Fauvel, INRAe, CESBIO \includegraphics[width=0.08\linewidth]{pictures/mathieu.jpg}
\item Nicolas Dobigeon, Toulouse-INP, IRIT \includegraphics[width=0.08\linewidth]{pictures/nicolas.png}
